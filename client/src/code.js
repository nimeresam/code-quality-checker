...
const LoadingSpinner = () => (
    <div style={{ textAlign: "center", padding: "20px" }}>
        <div style={{ border: "4px solid #f3f3f3", borderTop: "4px solid #4A90E2", borderRadius: "50%", width: "50px", height: "50px", animation: "spin 2s linear infinite" }}></div>
    </div>
);
...
const CodeQualityChecker = () => {
    ...
    return (
        <div style={{ margin: "50px", fontFamily: "Arial, sans-serif" }}>
            <h1 style={{ textAlign: "center", color: "#4A90E2" }}>Code Quality Checker</h1>
            <form
            ...
            >
                <div style={{ marginBottom: "20px" , width: "100%" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", margin: "20px 0" }}>
                        <div style={{ flex: 1, borderBottom: "1px solid #ccc", margin: "0 10px" }}></div>
            ...
            {response && (
                ...
                >
                    <h2 style={{ textAlign: "center", color: "#4CAF50", fontSize: "1.8rem", marginBottom: "20px" }}>
                        Code Quality Feedback
                    </h2>
                    <div style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "#555" }}>
                        <div style={{ marginBottom: "15px" }}>
                            <h3 style={{ color: "#4A90E2", display: "flex", alignItems: "center" }}>
                        ...
                        <div style={{ marginBottom: "15px" }}>
                            <h3 style={{ color: "#E67E22", display: "flex", alignItems: "center" }}>
                                <span style={{ marginRight: "10px", fontSize: "1.2rem" }}>⚠</span>
                                Improvements
                            </h3>
                            <ul>
                                <li><strong>Comments:</strong> {response.improvements.comments}</li>
                                <li><strong>Structure:</strong> {response.improvements.structure}</li>
                                <li><strong>Error Handling:</strong> {response.improvements.errorHandling}</li>
                            </ul>
                        </div>
                        <div style={{ marginTop: "20px", fontSize: "1.5rem", color: "#4A90E2", fontWeight: "bold" }}>
